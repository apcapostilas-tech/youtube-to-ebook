...
import { Link2, BookOpen, Zap, ShieldCheck, Loader, ChevronRight, Key } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const extractRes = await fetch("/api/extract", {
        ...
        body: JSON.stringify({ url, anthropicKey: apiKey || undefined }),
      });
        ...
        <form onSubmit={handleSubmit} className="max-w-2xl w-full space-y-4">
          ...
          <div className="flex items-center gap-3 bg-white/3 border border-white/5 rounded-xl px-4 py-3">
            ...
            <input
              ...
              placeholder="Sua Anthropic API Key (opcional — use a sua e economize)"
